...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_KEYCODE2SYSTEM_key_65536_89:
	.ds 1
_KEYCODE2CONSUMER_key_65536_92:
	.ds 1
_IS_NOEVENT_PARM_1:
	.ds 6
_IS_EVENT_PARM_1:
...
;------------------------------------------------------------
;key                       Allocated with name '_KEYCODE2SYSTEM_key_65536_89'
;------------------------------------------------------------
...
_KEYCODE2SYSTEM:
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#_KEYCODE2SYSTEM_key_65536_89
	movx	@dptr,a
...
;------------------------------------------------------------
;key                       Allocated with name '_KEYCODE2CONSUMER_key_65536_92'
;------------------------------------------------------------
...
_KEYCODE2CONSUMER:
	mov	a,dpl
	mov	dptr,#_KEYCODE2CONSUMER_key_65536_92
	movx	@dptr,a
...
;	quantum/keyboard.h:66: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'bootmagic'
;------------------------------------------------------------
;	quantum/bootmagic/magic.c:30: __attribute__((weak)) void bootmagic(void) {}
;	-----------------------------------------
;	 function bootmagic
;	-----------------------------------------
_bootmagic:
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'magic'
;------------------------------------------------------------
;default_layer             Allocated with name '_magic_default_layer_65537_215'
;------------------------------------------------------------
;	quantum/bootmagic/magic.c:36: void magic(void) {
;	-----------------------------------------
;	 function magic
;	-----------------------------------------
_magic:
;	quantum/bootmagic/magic.c:38: if (!eeconfig_is_enabled()) {
	lcall	_eeconfig_is_enabled
	mov	a,dpl
	jnz	00102$
;	quantum/bootmagic/magic.c:39: eeconfig_init();
	lcall	_eeconfig_init
00102$:
;	quantum/bootmagic/magic.c:43: debug_config.raw  = eeconfig_read_debug();
	lcall	_eeconfig_read_debug
	mov	r7,dpl
	mov	dptr,#_debug_config
	mov	a,r7
	movx	@dptr,a
;	quantum/bootmagic/magic.c:44: keymap_config.raw = eeconfig_read_keymap();
	lcall	_eeconfig_read_keymap
	mov	r6,dpl
	mov	r7,dph
	...
	inc	dptr
	movx	@dptr,a
;	quantum/bootmagic/magic.c:46: bootmagic();
	lcall	_bootmagic
;	quantum/bootmagic/magic.c:49: layer_state_t default_layer = (layer_state_t)eeconfig_read_default_layer();
	lcall	_eeconfig_read_default_layer
;	quantum/bootmagic/magic.c:50: default_layer_set(default_layer);
	mov	r6,#0x00
	mov	dph,r6
;	quantum/bootmagic/magic.c:53: layer_state_set_kb((layer_state_t)layer_state);
