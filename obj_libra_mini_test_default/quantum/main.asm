...
;--------------------------------------------------------
	...
	.globl _ACC
	.globl _PSW
	.globl _protocol_init
	.globl _protocol_task
	.globl _main
;--------------------------------------------------------
...
;	quantum/keyboard.h:66: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'protocol_init'
;------------------------------------------------------------
;	quantum/main.c:30: void protocol_init(void) {
;	-----------------------------------------
;	 function protocol_init
;	-----------------------------------------
_protocol_init:
;	quantum/main.c:31: protocol_pre_init();
	lcall	_protocol_pre_init
;	quantum/main.c:33: keyboard_init();
	lcall	_keyboard_init
;	quantum/main.c:35: protocol_post_init();
;	quantum/main.c:36: }
	ljmp	_protocol_post_init
;------------------------------------------------------------
;Allocation info for local variables in function 'protocol_task'
;------------------------------------------------------------
;	quantum/main.c:39: void protocol_task(void) {
;	-----------------------------------------
;	 function protocol_task
;	-----------------------------------------
_protocol_task:
;	quantum/main.c:40: protocol_pre_task();
	lcall	_protocol_pre_task
;	quantum/main.c:42: keyboard_task();
	lcall	_keyboard_task
;	quantum/main.c:44: protocol_post_task();
;	quantum/main.c:45: }
	ljmp	_protocol_post_task
;------------------------------------------------------------
;Allocation info for local variables in function 'main'
;------------------------------------------------------------
;	quantum/main.c:52: int main(void) {
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	quantum/main.c:53: platform_setup();
	lcall	_platform_setup
;	quantum/main.c:54: protocol_setup();
	lcall	_protocol_setup
;	quantum/main.c:55: keyboard_setup();
	lcall	_keyboard_setup
;	quantum/main.c:57: protocol_init();
	lcall	_protocol_init
;	quantum/main.c:60: while (true) {
00102$:
;	quantum/main.c:61: protocol_task();
	lcall	_protocol_task
;	quantum/main.c:75: housekeeping_task();
	lcall	_housekeeping_task
;	quantum/main.c:77: }
	sjmp	00102$
	.area CSEG    (CODE)
	.area CONST   (CODE)
